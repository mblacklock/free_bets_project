...
class NavbarTest(FunctionalTest):
    ...
    def test_navbar_login_works(self):
        ...
        login.find_element_by_css_selector('input').clear()
        login.find_element_by_css_selector('input').send_keys('edith@example.com')
        login.find_element_by_css_selector('input').send_keys(Keys.ENTER)
